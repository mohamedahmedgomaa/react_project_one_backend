...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'status_id' => 'حالة',
        'form_questions' => 'سؤال النموذج',
        'form_questions.*.type' => 'نوع',
        'form_questions.*.is_mandatory' => 'إلزامي',
        'form_questions.*.entries' => 'إدخالات',
        'form_questions.*.entries.*.ar' => 'إدخالات بالعربى',
        'form_questions.*.entries.*.en' => 'إدخالات بالانجليزى',
        'form_questions.*.question' => 'سؤال',
        'form_questions.*.question.ar' => 'سؤال بالعربى',
        'form_questions.*.question.en' => 'سؤال بالانجليزى',
        'items.*.quantity' => 'الكميه',
    ],
